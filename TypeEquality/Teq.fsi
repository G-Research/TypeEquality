...
module Teq =
    ...
    module Cong =
        ...
        val key<'k1, 'k2, 'v when 'k1 : comparison and 'k2 : comparison> : Teq<'k1, 'k2> -> Teq<Map<'k1, 'v>, Map<'k2, 'v>>
        ...
        val value<'v1, 'v2, 'k when 'k : comparison> : Teq<'v1, 'v2> -> Teq<Map<'k, 'v1>, Map<'k, 'v2>>
        ...
        val ok<'ok1, 'ok2, 'error> : Teq<'ok1, 'ok2> -> Teq<Result<'ok1, 'error>, Result<'ok2, 'error>>
        ...
        val error<'error1, 'error2, 'ok> : Teq<'error1, 'error2> -> Teq<Result<'ok, 'error1>, Result<'ok, 'error2>>
